...
for cases = 1:5
    ...
    Cov_train = Layer3(ind_train,:,:);
    Cov_test = Layer3(ind_test,:,:);
...
%     
%     Reshape covariances
%     Cov_train = reshape(Cov_train,[(size(Layer3,2))^2,size(Cov_train,1)])';
%     Cov_test = reshape(Cov_test,[(size(Layer3,2))^2,size(Cov_test,1)])';
%     
%     
...
save AccuracyLayer3Stein.mat accuracy